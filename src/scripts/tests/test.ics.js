...
describe('ICS', function () {
    it('On génère un ics sans rrule', function () {
        ...
        ics.addEvent(
            ...
            'Vous pouvez faire votre suivi quotidien sur https://mesconseilscovid.sante.gouv.fr//suivi/introduction',
            startDate,
            duration,
            rrule,
            now
...
UID:0@default
CLASS:PUBLIC
DESCRIPTION:Vous pouvez faire votre suivi quotidien sur https://mesconseilscovid.sante.gouv.fr//suivi/introduction
...
END:VCALENDAR`
    ...
    it('On génère un ics avec rrule', function () {
        ...
        ics.addEvent(
            'Suivi Covid-19',
            'Aller faire mon suivi quotidien sur https://mesconseilscovid.sante.gouv.fr//suivi/introduction',
            startDate,
            duration,
            rrule,
            now
...
UID:0@default
CLASS:PUBLIC
DESCRIPTION:Aller faire mon suivi quotidien sur https://mesconseilscovid.sante.gouv.fr//suivi/introduction
